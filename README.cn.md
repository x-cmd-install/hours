...
[![x-cmd/install — hours Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/hours.svg?lang=zh)](https://x-cmd.com/install/hours)
...
- **上游仓库**: <https://github.com/dhth/hours>
- **官网**: <https://tools.dhruvs.space/hours>
- **许可证**: MIT
...
- **Star**: 348 · **Fork**: 16 · **开放 issue**: 25 · **贡献者**: 4

## 累计统计

- **发布数**: 7 · **已合并 PR**: 119 · **开放 PR**: 4 · **已关闭 issue**: 12 · **开放 issue**: 13 · **提交数**: 178

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-26 | 0 | 1 | 0 | 0 | 1 | 3 |
| last60d | 2026-07-27 | 0 | 5 | 0 | 0 | 1 | 8 |
| 90d | 2026-06-27 | 0 | 13 | 1 | 0 | 2 | 17 |
| last180d | 2026-03-29 | 0 | 27 | 2 | 0 | 2 | 34 |
| 360d | 2025-09-30 | 0 | 58 | 2 | 0 | 3 | 62 |
| last720d | 2024-10-05 | 4 | 110 | 4 | 10 | 12 | 135 |
...
hours 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `hours` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/hours.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T05:35:35Z._
